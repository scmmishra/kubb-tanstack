...
export const findPetsByTagsQueryKey = (params?: MaybeRef<FindPetsByTags['queryParams']>) =>
...
>(
  ...
  options: {
    query?: Partial<
      QueryObserverOptions<FindPetsByTags['response'], FindPetsByTags['error'], TData, TQueryKey>
    >
