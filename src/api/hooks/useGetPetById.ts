...
export const getPetByIdQueryKey = (petId: MaybeRef<GetPetByIdPathParams['petId']>) =>
...
>(
  ...
  options: {
    query?: Partial<
      QueryObserverOptions<GetPetById['response'], GetPetById['error'], TData, TQueryKey>
    >
