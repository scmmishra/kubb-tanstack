...
/**
     ...
     * @link /pet/:petId */
export function useGetPetById<TData = GetPetById["response"], TQueryData = GetPetById["response"], TQueryKey extends QueryKey = GetPetByIdQueryKey>(refPetId: GetPetByIdPathParams["petId"], options: {
