...
export const findPetsByStatusQueryKey = (params?: MaybeRef<FindPetsByStatus["queryParams"]>) => [{ url: "/pet/findByStatus" }, ...(params ? [params] : [])] as const;
...
export function useFindPetsByStatus<TData = FindPetsByStatus["response"], TQueryData = FindPetsByStatus["response"], TQueryKey extends QueryKey = FindPetsByStatusQueryKey>(refParams?: MaybeRef<FindPetsByStatusQueryParams>, options: {
