...
export const getOrderByIdQueryKey = (orderId: MaybeRef<GetOrderByIdPathParams["orderId"]>) => [{ url: "/store/order/:orderId", params: { orderId: orderId } }] as const;
...
export function useGetOrderById<TData = GetOrderById["response"], TQueryData = GetOrderById["response"], TQueryKey extends QueryKey = GetOrderByIdQueryKey>(refOrderId: GetOrderByIdPathParams["orderId"], options: {
