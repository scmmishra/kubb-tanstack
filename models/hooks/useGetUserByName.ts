...
export const getUserByNameQueryKey = (username: MaybeRef<GetUserByNamePathParams["username"]>) => [{ url: "/user/:username", params: { username: username } }] as const;
...
/**
     ...
     * @link /user/:username */
export function useGetUserByName<TData = GetUserByName["response"], TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameQueryKey>(refUsername: GetUserByNamePathParams["username"], options: {
